...
for cnt_district in range(nb_districts):
    ...
    if sw_dataset == 'BEL':
        ...
        plt.legend()
        plt.show()
        #fig.savefig('C:/Users/odiao/Desktop/Redaction_darticles_Latex/SHR_PA/Figures/Dea.pdf')   # save the figure to file
        #plt.close(fig)
        # ***********************************************************************************
...
#***************************************************************
    ...
    #fig.savefig('C:/Users/odiao/Desktop/Redaction_darticles_Latex/SHR_PA/Figures/R_bar_opt.pdf')   # save the figure to file
    #plt.close(fig)  
#***************************************************************
#Least squares to estiate gamma, N_bar=S_bar_init+Hinit and beta_bar
#***************************************************************
  ...
  #np.sum(new_out_raw+death)/np.sum(total_in)
    ...
    fig=plt.figure(figsize=(12,6))
    plt.plot(u, y, 'o', markersize=4, label='observed data')
    plt.plot(u_test, y_test, label='fitted model')
    plt.xlabel("Cumulative number of fatalities", fontsize=16)
    plt.ylabel("Daily fatalities", fontsize=16)
    plt.legend(fontsize=16)
    plt.tick_params(labelsize=14)
    plt.show()
    #fig.savefig('C:/Users/odiao/Desktop/Submit to CDD\Epreuve de confirmation Ousmane\Figures/fd_opt.pdf')   # save the figure to file
    #plt.close(fig)
 #****************************************************************   
